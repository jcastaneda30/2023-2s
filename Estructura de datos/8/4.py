...
class AVLTree(object):
    ...
    def _inOrderRecursively(self, root, elements,profundidad):
        if root:
            self._inOrderRecursively(root.right, elements,profundidad+1)
            print("\t"*profundidad,end="")
            print(root.key)
            self._inOrderRecursively(root.left, elements,profundidad+1)
