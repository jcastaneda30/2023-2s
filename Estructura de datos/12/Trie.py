...
a = Trie()
palabras = ['maria', 'mar', 'marca', 'marte']

for p in palabras:
    a.insert(p)

print(a.search('marte'))  # True
print(a.search('mano'))    # False

print(a.startsWithPrefix('ma'))  # True

a.delete('maria')
print(a.search('maria'))  # False

print(a.count)  # 3

print(a.traverse())  # ['mar', 'marca', 'marte']
